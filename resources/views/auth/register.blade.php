                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="usertype" id="flexRadioDefault1" value="freelancer" checked>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Freelancer
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="usertype" id="flexRadioDefault2" value="client">
